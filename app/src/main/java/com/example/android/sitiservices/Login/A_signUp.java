        ...
        firebaseAuth.createUserWithEmailAndPassword(Email.getEditableText().toString(),Password.getEditableText().toString())
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            D_UserDataToFirebase user=new D_UserDataToFirebase(Name.getEditableText().toString(),Email.getEditableText().toString(),Phone.getEditableText().toString(),Gender,Password.getEditableText().toString());
