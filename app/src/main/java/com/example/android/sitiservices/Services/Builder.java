...
public class Builder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.activity_builder,container,false);
    ...
    public void setRecyclerView(View view)
    {
        ...
        myAdapterSneakers.setOnCardViewItemClickListener(new OnCardViewItemClickListener() {
            ...
            public void onItemClickListenerOfCardView(int position) {
                ...
                intent.putExtra("ProductCategoryByMaterial","Builder");
    ...
    {
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("Workers").child("Builder");
