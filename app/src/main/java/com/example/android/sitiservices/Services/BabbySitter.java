 ...
 */
public class BabbySitter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.activity_babby_sitter,container,false);
    ...
    public void setRecyclerView(View view)
    {
        ...
        myAdapterSneakers.setOnCardViewItemClickListener(new OnCardViewItemClickListener() {
            ...
            public void onItemClickListenerOfCardView(int position) {
                ...
                intent.putExtra("ProductCategoryByMaterial","BabySitter");
    ...
    {
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("Workers").child("BabySitter");
