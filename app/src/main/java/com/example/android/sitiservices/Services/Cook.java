 ...
 */
public class Cook extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.activity_cook,container,false);
    ...
    public void setRecyclerView(View view)
    {
        ...
        myAdapterSneakers.setOnCardViewItemClickListener(new OnCardViewItemClickListener() {
            ...
            public void onItemClickListenerOfCardView(int position) {
                ...
                intent.putExtra("ProductCategoryByMaterial","Cook");
    ...
    {
        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("Workers").child("Cook");
