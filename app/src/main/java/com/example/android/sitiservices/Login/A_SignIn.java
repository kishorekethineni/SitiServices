...
import com.example.android.sitiservices.MainActivity;
...
public class A_SignIn extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gotosignup=findViewById(R.id.Sign_In_txt_SignUP_Link);
        ...
        gotosignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotosignupintent=new Intent(A_SignIn.this,A_signUp.class);
    ...
    */
    ...
    private void storeGoogleSigInedUsersData(final FirebaseUser firebaseUser)
    {
        ...
        if (acct != null) {
            ...
            final D_UserDataToFirebase d_userDataToStoreInFirebase=new D_UserDataToFirebase(Name,Email,Phone,Gender,"");
    ...
    class ASyncTaskToFetchCurrentUserData extends AsyncTask<Void,Void,Void> {
        ...
        private void setData(D_UserDataToFirebase d_currentUser) {
